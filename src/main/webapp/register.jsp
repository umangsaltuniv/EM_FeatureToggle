									...
									<div class="row my-3">
										...
										<div  class="col-6">
											<a href="${pageContext.request.contextPath}/login.jsp">
												<button id="login-id" type="button" class="btn btn-block">
...
<script type="text/javascript">
	var button_color_blue = "${button_color_blue}";
	alert(button_color_blue);
	if(button_color_blue == "true"){
		$("#login-id").addClass("btn-primary");
	} else {
		$("#login-id").addClass("btn-success");
	}
</script>
</body>
</html>